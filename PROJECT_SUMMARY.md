...
| # | Задача | Статус |
|---|--------|--------|
| 1 | Добавить метод изменения статуса в applicationService | [DONE] |
| 2 | Добавить смену статуса в ApplicationView (выпадающий список) | [DONE] |
| 3 | Добавить смену статуса в ApplicationsList (таблица) | [DONE] |
| 4 | Поправить оформление кнопок и иконок | [DONE] |
| 5 | Обновить функцию canEdit в ApplicationsList для админа | [DONE] |
| 6 | Добавить навигацию по клику на логотип | [DONE] |
| 7 | Добавить редирект на /admin для админов | [DONE] |
| 8 | Убрать вкладку "Обзор" из админ-панели | [DONE] |
| 9 | Добавить редактирование пользователей | [DONE] |
| 10 | Добавить редактирование экспертов | [DONE] |
| 11 | Обновить тестовые данные для экспертов | [DONE] |
| 12 | Унифицировать стили через components.css | [DONE] |
